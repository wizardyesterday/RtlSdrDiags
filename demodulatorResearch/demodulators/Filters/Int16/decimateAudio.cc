...
int16_t outputBuffer[80000];

// File output buffer.
int16_t fileOutputBuffer[80000];

Decimator_int16 *myFilterPtr;
...
int main(int argc,char **argv)
{
  ...
  // Create decimator.
  myFilterPtr = new Decimator_int16(filterLength,h32000,4);
  ...
  {
    sampleAvailable = myFilterPtr->decimate(sampleBuffer[i],&sample);
