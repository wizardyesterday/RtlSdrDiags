...
// an input signal, that is sampled at 512000 S/s can be decimated
// to 256000 S/s.  We want to limit the bandwidth of the aliasing
...
title("Antialiasing Filter - Sample Rate: 512000 S/s  (non-decimated)");
a = gca();
