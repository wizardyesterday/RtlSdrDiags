//************************************************************************
// file name: testFmDemodulator.cc
//************************************************************************
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
// This program tests the FmDemodulator class by reading a file that
// contains IQ samples that represent a narrowband FM signal.
// To build, type,
//  g++ -o testFmDemodulator testFmDemodulator.cc Decimator.cc -lm
//
// To run, type,
// ./testFmDemodulator <inputFile >outputFile
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
